...
var hobbies = ["swimming", "reading", "singing"];
console.log(hobbies);
...
languages.map(function (language) { return console.log(language.toUpperCase()); });
// Use the filter() method to create a new array with languages that contain
// the letter 'a' and log the new array to the console.
var newLanguagesArray = languages.filter(function (language) {
    return language.includes("a");
});
...
var mixedValuesConcatenateString = mixedValues.reduce(function (acc, val) {
