...
var mixedArray = [4, "a", 7, "ty"];
console.log(mixedArray);
mixedArray.forEach(function (value) { return console.log(value, typeof value); });
...
function processValues(param1, param2) {
...
function filterNumbers(array) {
    var newArray = array.filter(function (val) { return typeof val === "number"; });
    return newArray;
}
